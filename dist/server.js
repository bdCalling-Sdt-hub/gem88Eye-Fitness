...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const port = Number(config_1.default.port) || 8080;
            typeof config_1.default.port === 'number' ? config_1.default.port : Number(config_1.default.port);
            server = app_1.default.listen(port, () => {
                logger_1.logger.info(colors_1.default.yellow(`♻️  Application listening on port:${port}`));
            });
            //socket
