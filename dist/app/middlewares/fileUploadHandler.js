        ...
        destination: (req, file, cb) => {
            ...
            switch (file.fieldname) {
                ...
                case 'media':
                    ...
                    break;
                case 'documents':
                    uploadDir = path_1.default.join(baseUploadDir, 'documents');
                    break;
                default:
    ...
    const filterFilter = (req, file, cb) => {
        if (file.fieldname === 'image') {
            ...
            if (file.mimetype === 'application/pdf' || file.mimetype === 'text/csv') {
                ...
                cb(new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Only pdf or csv files supported'));
            }
        }
        else {
